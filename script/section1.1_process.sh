#!/bin/bash
#title          :section1.1_process.sh
#description    :This script includes all functions before ortholog searching
#author         :Ruby(Yiru) Sheng
#usage          :source $CMRP_PATH/script/section1.1_process.sh
