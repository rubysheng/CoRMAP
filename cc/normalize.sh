#!/bin/bash
#SBATCH --time=1-00:10:00                   # Time limit hrs:min:sec
...
#rm $EBROOTTRINITY/trinityrnaseq-Trinity-v2.8.5/util/support_scripts/nbkc_normalize.pl
#cp ~/nbkc_normalize.pl $EBROOTTRINITY/trinityrnaseq-Trinity-v2.8.5/util/support_scripts/
#chmod 777 $EBROOTTRINITY/trinityrnaseq-Trinity-v2.8.5/util/support_scripts/nbkc_normalize.pl

echo ==== Trinity In silico Read Normalization START ====
OUTDIR="./normalization_dir/"
/home/ruby/trinityrnaseq-2.8.5/util/insilico_read_normalization.pl --seqType fq --JM 150G --max_cov 50 \
