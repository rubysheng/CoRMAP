...
# Group_Num	Species	Project	gene	treatment	TPM_Value
i=1
for (i in 1:length(files)){
  project <- files[i]
  file_path <- paste0("C:/Users/tts_p/Documents/MSc/MSc_thesis/RNA-seq/expression/output/Newfolder/long_format_",project,"_mulgp.txt")
